 ...
 * 
 */
@WebServiceClient(name = "CustomerService", targetNamespace = "http://ebank_services/", wsdlLocation = "http://localhost:9090/EBank/CustomerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICE_QNAME = new QName("http://ebank_services/", "CustomerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/EBank/CustomerService?wsdl");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://ebank_services/", "CustomerServicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ebank_services/", "CustomerServicePort"), CustomerService.class, features);
    }
